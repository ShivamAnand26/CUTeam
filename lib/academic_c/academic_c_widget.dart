...
class AcademicCWidget extends StatefulWidget {
  const AcademicCWidget({Key? key}) : super(key: key);

  @override
  _AcademicCWidgetState createState() => _AcademicCWidgetState();
}

class _AcademicCWidgetState extends State<AcademicCWidget> {
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: FlutterFlowPdfViewer(
                                            assetPath:
                                                'assets/pdfs/Academic_Calendar_2022-23.pdf',
                                            height: 300,
